                    ...
                    <Grid container spacing={4} rowSpacing={4}>
                        <Grid item xs={6} sm={6} md={6} lg={6}>
                            <Box component={Card} p={4} alignItems='center'
                                ...
                                <Box px={2}>
                                    <Typography color='#28313c' fontWeight={600} fontSize={17}>{userData.UserName}</Typography>
                                    <Typography color='#616e80' variant='subtitle1'>Investor</Typography>
                                    <Typography color='#616e80' variant='caption'>Customer Id : IN23-1</Typography>
                                </Box>
                            </Box>
                        ...
                        <Box mt={1} mb={2} component={Card} p={2} display='flex' justifyContent='space-between' flexDirection='column'>
                                ...
                                <Box  mt={5} >
                                  <Grid container spacing={2}  display='flex' flexDirection='row' justifyContent='space-evenly'>
                                  <Grid item xs={4} sm={4} md={4} lg={4}>
                                     <Box textAlign='center' display='flex' flexDirection='column' gap={1}>
                                        <Typography color='#3860b5'>Phone Number</Typography>
                                        <Typography color='#84cb25'  variant='subtitle2'>{userData.UserMobile}</Typography>
                                    </Box>
                                  </Grid>
                                   <Grid item xs={4} sm={4} md={4} lg={4}>
                                       <Box textAlign='center' display='flex' flexDirection='column' gap={1}>
                                        <Typography color='#3860b5'>Email</Typography>
                                        <Typography color='#84cb25'  variant='subtitle2'>{userData.UserEmail}</Typography>
                                    </Box>
                                  </Grid>
                                   <Grid item xs={4} sm={4} md={4} lg={4}>
                                   <Box textAlign='center' display='flex' flexDirection='column' gap={1}>
                                        <Typography color='#3860b5'>Address</Typography>
                                        <Typography color='#84cb25' variant='subtitle2'>{userData.UserCity}, {userData.UserState}</Typography>
                                    </Box>
                                  </Grid>
                                  </Grid>                      
                                </Box>
